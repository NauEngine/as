...
Function* createAdd(LLVMContext& Context, Module *M, int constant)
{
...
Function* createFoo(LLVMContext& Context, Module *M, Function* fadd, int constant, const char* name)
{
...
void callFunc(ExecutionEngine* EE, Function* func)
{
...
int main()
{
  ...
  Function* fadd = createAdd(Context, M, 1);
  Function* ffoo = createFoo(Context, M, fadd, 20, "foo");
  Function* ffoo2 = createFoo(Context, M, fadd, 30, "foo2");
